...
public class Panel {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if(Client.sm.getSettingByName("Design").getValString().equalsIgnoreCase("New")){
		...
		}else if(Client.sm.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike")){
		...
		if (this.extended && !Elements.isEmpty()) {
			...
			int epanelcolor = Client.sm.getSettingByName("Design").getValString().equalsIgnoreCase("New") ? 0xff232323 : Client.sm.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike") ? 0xbb151515 : 0;;
