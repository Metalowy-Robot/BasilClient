...
import Basil.Client;
import Basil.gui.GuiIngameHook;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading " + Basil.Client.name + " " + Basil.Client.version);
    ...
    {
	    //Basil
	    if (this.getMinecraft().thePlayer != null) {
    ...
    private void sendClickBlockToController(boolean leftClick)
    {
        if (!leftClick)
        {
        	if (leftClickCounter >= 100 || !((
        			Client.sm.getSettingsByMod(Client.moduleManager.getModuleByName("[HC] Hitreg")).get(0).getValString().equalsIgnoreCase("HARD")
        			|| 
        			Client.sm.getSettingsByMod(Client.moduleManager.getModuleByName("[HC] Hitreg")).get(0).getValString().equalsIgnoreCase("EXTREME")
        			) && Client.moduleManager.getModuleByName("[HC] Hitreg").isToggled()
        			))
    ...
    {
    	//Basil
        if (this.leftClickCounter <= 0 || ((Basil.module.combat.Hitreg)Client.moduleManager.getModuleByName("1.7Hitreg")).hitreg)
        {
            this.thePlayer.swingItem();
            ...
            if (this.objectMouseOver == null)
            {
                ...
                if (this.playerController.isNotCreative())
                {
                    ...
                    if(Client.moduleManager.getModuleByName("[HC] Hitreg").isToggled()) {
                    	this.leftClickCounter = (int) ((Basil.module.hardcore.HCHitreg)Client.moduleManager.getModuleByName("[HC] Hitreg")).getHitreg();
                    }
                }
            }
            else
            {
                switch (this.objectMouseOver.typeOfHit)
                {
                    ...
                    case MISS:
                    default:
                        if (this.playerController.isNotCreative() && ((Basil.module.combat.Hitreg)Client.moduleManager.getModuleByName("1.7Hitreg")).hitreg == false)
                        {
                            this.leftClickCounter = 10;
                            if(Client.moduleManager.getModuleByName("[HC] Hitreg").isToggled()) {
                            	this.leftClickCounter = (int) ((Basil.module.hardcore.HCHitreg)Client.moduleManager.getModuleByName("[HC] Hitreg")).getHitreg();
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                    	...
                    	Basil.module.ModuleManager.onKey(k);
